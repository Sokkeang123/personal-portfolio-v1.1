...
//                 applications using modern programming languages such as HTML,
//                 CSS, JavaScript frameworks including React, Next.js and
//                 TailwindCss also, especially databases, and backend APIs.One
//                 more think I also have knowlege about Figma Tool, and GitHub for
...
//           {/* Card 3: Additional Short Courses */}
...
//           {/* Card 4: Technical Stack Learned */}
//           <div className="relative lg:row-span-2">
...
//                 </div>
//                 <div>
//                   <p className="font-semibold text-indigo-300">Productivity</p>
//                   <p className="text-gray-300">MS Word, Excel, PowerPoint</p>
//                 </div>
//               </div>
//             </div>
